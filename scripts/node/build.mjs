...
// scripts/node/lib/prompt.mjs get inlined, only Node built-ins (node:fs, etc.)
...
if (isDev) {
  ...
  await ctx.watch();
  console.log("==> Watching scripts/node/ for changes (unminified, sourcemaps on)... Ctrl+C to stop.");
} else {
