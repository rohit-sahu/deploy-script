...
echo ""
echo "=== 3. fail2ban (module_fail2ban) ==="
...
echo ""
echo "=== 4. sysctl hardening (module_sysctl_hardening) ==="
...
echo ""
echo "=== 5. Docker (run_install_docker + configure_docker_daemon) ==="
...
echo ""
echo "=== 7. App user (module_create_app_user) ==="
...
echo ""
echo "=== 8. Repo sync (run_sync_repo) ==="
...
echo ""
echo "=== 9. apt version-comparison bug fix (Ubuntu/Debian only) ==="
if [[ "$ID" == "ubuntu" || "$ID" == "debian" ]]; then
